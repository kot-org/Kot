...
gldelf_i386_get_script (int *isfile)
{
  *isfile = 1;
  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
	...
	return "ldscripts/elf_i386.xdwe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386.xdce";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386.xswe";
      else
    ...
    {
      if (link_info.separate_code)
	return "ldscripts/elf_i386.xsce";
      else
