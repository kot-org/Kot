...
__attribute__((__noreturn__)) void kot_Srv_System_LoadExecutableToProcess(char* Path, void* Data, size64_t Size, uint64_t DataPosition, struct kot_arguments_t* Arguments, uint64_t Flags);
