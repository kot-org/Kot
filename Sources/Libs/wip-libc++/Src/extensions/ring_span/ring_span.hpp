...
#ifndef stdext_RING_SPAN_LITE_HPP
#define stdext_RING_SPAN_LITE_HPP
...
#if nsrs_CPP11_OR_GREATER
    template< bool b = true, typename = stdext::enable_if_t<b && std::is_copy_assignable<T>::value> >
...
#if nsrs_CPP11_OR_GREATER
    template< bool b = true, typename = stdext::enable_if_t<b && std::is_move_assignable<T>::value> >
...
<
    ...
    , typename stdext::conditional<is_const, const typename RS::value_type, typename RS::value_type>::type
>
#endif
...
public:
    ...
    typedef typename stdext::conditional<is_const, const value_type, value_type>::type * pointer;
    typedef typename stdext::conditional<is_const, const value_type, value_type>::type & reference;
...
private:
    ...
    typedef typename stdext::conditional<is_const, const RS, RS>::type ring_type;

    ring_iterator( size_type idx, typename stdext::conditional<is_const, const RS, RS>::type * rs ) nsrs_noexcept
    : m_idx( idx )
    , m_rs ( rs  )
    {}
...
#endif // stdext_RING_SPAN_LITE_HPP
