...
typedef KResult (*client_vfs_dispatch_t)(thread_t Callback, uint64_t CallbackArg, struct ClientVFSContext* Context, kot_permissions_t Permissions, uint64_t GP0, uint64_t GP1, uint64_t GP2);
