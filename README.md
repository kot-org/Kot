...
# Just run kot
Download the latest release <a href="https://github.com/kot-org/Kot/releases">here</a> and make it run on an x86-64 emulator like qemu-kvm, bochs, vmware, virtual box, ...
